...
def create_venue_submission():
    ...
    try:
        ...
        newVenue.seeking_talent = data.get("seeking_talent")
        newVenue.seeking_description = data.get("seeking_description")
        # TODO(NK): remove print statement
        print(data.get("name"), data.get("city"), data.get("state"), data.get("address"), data.get("phone"),
              data.get("genres"), data.get("facebook_link"), data.get("image_link"),
              data.get("website_link"), data.get("seeking_talent"), data.get("seeking_description"))
